...
\newcommand{\crcdesc}{\textbf{Cyclic Redundancy Check} ist ein Verfahren, basierend auf der modularen Polynomdivision (mod 2), welches dazu verwendet wird, einen Prüfwert.}
