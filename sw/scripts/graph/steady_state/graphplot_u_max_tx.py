...
plot [0:13] [0:130] 98.2 lc rgb"#eee8aa" lw 30 notitle with lines, \
    98.06 title "Average" lc rgb"#9932cc" with lines, \
    "data/udp/tx_max_rate" using 1:2 title "U.MAX TX" lc rgb"blue" with lines
