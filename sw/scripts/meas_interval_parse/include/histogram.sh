...
if [ -z "$4" ]
then
    echo "Usage: $0 meas_interval_file OUTPUT_FOLDER TITLE HISTOGRAM_TEX_SAVEDIR"
...
OUTPUT_FOLDER=$2
HISTOGRAM_TEXT_OUT_FOLDER=$4
HISTOGRAM_TEXT_OUT_FILE="${HISTOGRAM_TEXT_OUT_FOLDER}/histograms.tex"
...
echo "\begin{figure}[H]" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\noindent \begin{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\histocpu{${OUTPUT_FOLDER#"${HISTOGRAM_TEXT_OUT_FOLDER}/"}/${CPU_LOAD_PER_INT}}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\par\end{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\protect\caption{$3 - CPU-load per interval}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\end{figure}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "done"
...
echo "\begin{figure}[H]" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\noindent \begin{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\histocpuusr{${OUTPUT_FOLDER#"${HISTOGRAM_TEXT_OUT_FOLDER}/"}/${USER_TIME_PER_INT}}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\par\end{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\protect\caption{$3 - CPU-usertime per interval}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\end{figure}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "done"
...
echo "\begin{figure}[H]" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\noindent \begin{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\histocpusys{${OUTPUT_FOLDER#"${HISTOGRAM_TEXT_OUT_FOLDER}/"}/${SYSTEM_TIME_PER_INT}}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\par\end{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\protect\caption{$3 - CPU-systemtime per interval}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\end{figure}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "done"
...
echo "\begin{figure}[H]" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\noindent \begin{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\histonet{${OUTPUT_FOLDER#"${HISTOGRAM_TEXT_OUT_FOLDER}/"}/${PRP_RX_BYTES_PER_INT}}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\par\end{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\protect\caption{$3 - ${PRP_NAME} RX Bytes per interval}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\end{figure}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "done"
...
echo "\begin{figure}[H]" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\noindent \begin{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\histonet{${OUTPUT_FOLDER#"${HISTOGRAM_TEXT_OUT_FOLDER}/"}/${PRP_TX_BYTES_PER_INT}}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\par\end{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\protect\caption{$3 - ${PRP_NAME} TX Bytes per interval}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\end{figure}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "done"
...
echo "\begin{figure}[H]" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\noindent \begin{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\histonetspeed{${OUTPUT_FOLDER#"${HISTOGRAM_TEXT_OUT_FOLDER}/"}/${PRP_RX_BITRATE_PER_INT}}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\par\end{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\protect\caption{$3 - ${PRP_NAME} RX Bitrate per interval}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\end{figure}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "done"
...
echo "\begin{figure}[H]" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\noindent \begin{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\histonetspeed{${OUTPUT_FOLDER#"${HISTOGRAM_TEXT_OUT_FOLDER}/"}/${PRP_TX_BITRATE_PER_INT}}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\par\end{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\protect\caption{$3 - ${PRP_NAME} TX Bitrate per interval}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\end{figure}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "done"
...
echo "\begin{figure}[H]" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\noindent \begin{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\histonet{${OUTPUT_FOLDER#"${HISTOGRAM_TEXT_OUT_FOLDER}/"}/${IF0_RX_BYTES_PER_INT}}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\par\end{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\protect\caption{$3 - ${IF0_NAME} RX Bytes per interval}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\end{figure}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "done"
...
echo "\begin{figure}[H]" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\noindent \begin{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\histonet{${OUTPUT_FOLDER#"${HISTOGRAM_TEXT_OUT_FOLDER}/"}/${IF0_TX_BYTES_PER_INT}}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\par\end{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\protect\caption{$3 - ${IF0_NAME} TX Bytes per interval}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\end{figure}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "done"
...
echo "\begin{figure}[H]" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\noindent \begin{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\histonetspeed{${OUTPUT_FOLDER#"${HISTOGRAM_TEXT_OUT_FOLDER}/"}/${IF0_RX_BITRATE_PER_INT}}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\par\end{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\protect\caption{$3 - ${IF0_NAME} RX Bitrate per interval}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\end{figure}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "done"
...
echo "\begin{figure}[H]" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\noindent \begin{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\histonetspeed{${OUTPUT_FOLDER#"${HISTOGRAM_TEXT_OUT_FOLDER}/"}/${IF0_TX_BITRATE_PER_INT}}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\par\end{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\protect\caption{$3 - ${IF0_NAME} TX Bitrate per interval}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\end{figure}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "done"
...
echo "\begin{figure}[H]" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\noindent \begin{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\histonet{${OUTPUT_FOLDER#"${HISTOGRAM_TEXT_OUT_FOLDER}/"}/${IF1_RX_BYTES_PER_INT}}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\par\end{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\protect\caption{$3 - ${IF1_NAME} RX Bytes per interval}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\end{figure}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "done"
...
echo "\begin{figure}[H]" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\noindent \begin{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\histonet{${OUTPUT_FOLDER#"${HISTOGRAM_TEXT_OUT_FOLDER}/"}/${IF1_TX_BYTES_PER_INT}}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\par\end{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\protect\caption{$3 - ${IF1_NAME} TX Bytes per interval}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\end{figure}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "done"
...
echo "\begin{figure}[H]" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\noindent \begin{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\histonetspeed{${OUTPUT_FOLDER#"${HISTOGRAM_TEXT_OUT_FOLDER}/"}/${IF1_RX_BITRATE_PER_INT}}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\par\end{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\protect\caption{$3 - ${IF1_NAME} RX Bitrate per interval}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\end{figure}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "done"
...
echo "\begin{figure}[H]" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\noindent \begin{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\histonetspeed{${OUTPUT_FOLDER#"${HISTOGRAM_TEXT_OUT_FOLDER}/"}/${IF1_TX_BITRATE_PER_INT}}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\par\end{centering}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\protect\caption{$3 - ${IF1_NAME} TX Bitrate per interval}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "\end{figure}" >> ${HISTOGRAM_TEXT_OUT_FILE}
echo "done"
